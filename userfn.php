...
function PersonalData_Deleted($row) {
	...
	// untuk hilangkan warna merah di navbar
	Config("NAVBAR_CLASS", "main-header navbar navbar-expand navbar-light border-bottom");

	//class="main-header navbar navbar-expand navbar-dark bg-danger border-bottom"
?>