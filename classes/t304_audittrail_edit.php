 ...
 * Page class
 */
class t304_audittrail_edit extends t304_audittrail
{
	...
	// Page object name
	public $PageObjName = "t304_audittrail_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// datetime
			$this->datetime->setDbValueDef($rsnew, UnFormatDateTime($this->datetime->CurrentValue, 11), CurrentDate(), $this->datetime->ReadOnly);
