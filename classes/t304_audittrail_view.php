 ...
 * Page class
 */
class t304_audittrail_view extends t304_audittrail
{
	...
	// Page object name
	public $PageObjName = "t304_audittrail_view";
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if ($this->TotalRecords <= 0) { // No record found
						...
						$this->terminate("t304_audittraillist.php"); // Return to list page
					...
					if (!$matchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->phrase("NoRecord")); // Set no record message
						$returnUrl = "t304_audittraillist.php"; // No matching record, return to list
					} else {
						$this->loadRowValues($this->Recordset); // Load row values
					}
			}
		} else {
			$returnUrl = "t304_audittraillist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
