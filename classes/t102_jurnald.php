...
/**
 * Table class for t102_jurnald
 */
class t102_jurnald extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 't102_jurnald';
		$this->TableName = 't102_jurnald';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t102_jurnald`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new DbField('t102_jurnald', 't102_jurnald', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// jurnal_id
		$this->jurnal_id = new DbField('t102_jurnald', 't102_jurnald', 'x_jurnal_id', 'jurnal_id', '`jurnal_id`', '`jurnal_id`', 3, 11, -1, FALSE, '`jurnal_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->jurnal_id->IsForeignKey = TRUE; // Foreign key field
		$this->jurnal_id->Required = TRUE; // Required field
		$this->jurnal_id->Sortable = TRUE; // Allow sort
		$this->jurnal_id->Lookup = new Lookup('jurnal_id', 't101_jurnal', FALSE, 'id', ["nomer","","",""], [], [], [], [], [], [], '', '');
		$this->jurnal_id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['jurnal_id'] = &$this->jurnal_id;

		// akun_id
		$this->akun_id = new DbField('t102_jurnald', 't102_jurnald', 'x_akun_id', 'akun_id', '`akun_id`', '`akun_id`', 3, 11, -1, FALSE, '`akun_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->akun_id->Required = TRUE; // Required field
		...
		$this->akun_id->Lookup = new Lookup('akun_id', 't004_akun', FALSE, 'id', ["kode","nama","",""], [], [], [], [], [], [], '', '');
		$this->akun_id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['akun_id'] = &$this->akun_id;

		// debet
		$this->debet = new DbField('t102_jurnald', 't102_jurnald', 'x_debet', 'debet', '`debet`', '`debet`', 4, 15, -1, FALSE, '`debet`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// kredit
		$this->kredit = new DbField('t102_jurnald', 't102_jurnald', 'x_kredit', 'kredit', '`kredit`', '`kredit`', 4, 15, -1, FALSE, '`kredit`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getMasterFilter()
	{
		...
		if ($this->getCurrentMasterTable() == "t101_jurnal") {
			if ($this->jurnal_id->getSessionValue() != "")
				$masterFilter .= "`id`=" . QuotedValue($this->jurnal_id->getSessionValue(), DATATYPE_NUMBER, "DB");
			else
				return "";
		}
		return $masterFilter;
	...
	public function getDetailFilter()
	{
		...
		if ($this->getCurrentMasterTable() == "t101_jurnal") {
			if ($this->jurnal_id->getSessionValue() != "")
				$detailFilter .= "`jurnal_id`=" . QuotedValue($this->jurnal_id->getSessionValue(), DATATYPE_NUMBER, "DB");
			else
				return "";
		}
		return $detailFilter;
	...
	// Master filter
	public function sqlMasterFilter_t101_jurnal()
	{
		return "`id`=@id@";
	}

	// Detail filter
	public function sqlDetailFilter_t101_jurnal()
	{
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`t102_jurnald`";
	}
	...
	{
		global $Language;
		if ($pageName == "t102_jurnaldview.php")
			return $Language->phrase("View");
		elseif ($pageName == "t102_jurnaldedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "t102_jurnaldadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("t102_jurnaldview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("t102_jurnaldview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "t102_jurnaldadd.php?" . $this->getUrlParm($parm);
		else
			$url = "t102_jurnaldadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("t102_jurnaldedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("t102_jurnaldadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("t102_jurnalddelete.php", $this->getUrlParm());
	}

	// Add master url
	public function addMasterUrl($url)
	{
		if ($this->getCurrentMasterTable() == "t101_jurnal" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
