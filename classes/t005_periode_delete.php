 ...
 * Page class
 */
class t005_periode_delete extends t005_periode
{
	...
	// Page object name
	public $PageObjName = "t005_periode_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t005_periodelist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("t005_periodelist.php"); // Return to list
			}
		}
	}
