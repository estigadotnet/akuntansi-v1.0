...
class index
{
	...
	public function run()
	{
		...
		if ($Security->allowList(CurrentProjectID() . 't001_grup'))
			$this->terminate("t001_gruplist.php");
		if ($Security->allowList(CurrentProjectID() . 't002_subgrup'))
			$this->terminate("t002_subgruplist.php");
		if ($Security->allowList(CurrentProjectID() . 't003_matauang'))
			$this->terminate("t003_matauanglist.php");
		if ($Security->allowList(CurrentProjectID() . 't004_akun'))
			$this->terminate("t004_akunlist.php");
		if ($Security->allowList(CurrentProjectID() . 't005_periode'))
			$this->terminate("t005_periodelist.php");
		if ($Security->allowList(CurrentProjectID() . 't006_saldoawal'))
			$this->terminate("t006_saldoawallist.php");
		if ($Security->allowList(CurrentProjectID() . 't007_tipejurnal'))
			$this->terminate("t007_tipejurnallist.php");
		if ($Security->allowList(CurrentProjectID() . 't101_jurnal'))
			$this->terminate("t101_jurnallist.php");
		if ($Security->allowList(CurrentProjectID() . 't102_jurnald'))
			$this->terminate("t102_jurnaldlist.php");
