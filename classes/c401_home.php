...
class c401_home
{
	...
	// Table name
	public $TableName = 'c401_home.php';

	// Page object name
	public $PageObjName = "c401_home";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'c401_home.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "c401_home", $url, "", "c401_home", TRUE);
		$this->Heading = $Language->TablePhrase("c401_home", "TblCaption"); 
	}
} // End class
?>