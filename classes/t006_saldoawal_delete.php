 ...
 * Page class
 */
class t006_saldoawal_delete extends t006_saldoawal
{
	...
	// Page object name
	public $PageObjName = "t006_saldoawal_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t006_saldoawallist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("t006_saldoawallist.php"); // Return to list
			}
		}
	}
