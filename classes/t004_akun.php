...
/**
 * Table class for t004_akun
 */
class t004_akun extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 't004_akun';
		$this->TableName = 't004_akun';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t004_akun`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new DbField('t004_akun', 't004_akun', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// subgrup_id
		$this->subgrup_id = new DbField('t004_akun', 't004_akun', 'x_subgrup_id', 'subgrup_id', '`subgrup_id`', '`subgrup_id`', 3, 11, -1, FALSE, '`subgrup_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->subgrup_id->Required = TRUE; // Required field
		...
		$this->subgrup_id->Lookup = new Lookup('subgrup_id', 't002_subgrup', FALSE, 'id', ["kode","nama","",""], [], [], [], [], [], [], '', '');
		$this->subgrup_id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['subgrup_id'] = &$this->subgrup_id;

		// kode
		$this->kode = new DbField('t004_akun', 't004_akun', 'x_kode', 'kode', '`kode`', '`kode`', 200, 50, -1, FALSE, '`kode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->kode->Required = TRUE; // Required field
		$this->kode->Sortable = TRUE; // Allow sort
		$this->fields['kode'] = &$this->kode;

		// nama
		$this->nama = new DbField('t004_akun', 't004_akun', 'x_nama', 'nama', '`nama`', '`nama`', 200, 50, -1, FALSE, '`nama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nama->Required = TRUE; // Required field
		$this->nama->Sortable = TRUE; // Allow sort
		$this->fields['nama'] = &$this->nama;

		// matauang_id
		$this->matauang_id = new DbField('t004_akun', 't004_akun', 'x_matauang_id', 'matauang_id', '`matauang_id`', '`matauang_id`', 3, 11, -1, FALSE, '`matauang_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->matauang_id->Required = TRUE; // Required field
		...
		$this->matauang_id->Lookup = new Lookup('matauang_id', 't003_matauang', FALSE, 'id', ["nama","kode","",""], [], [], [], [], [], [], '', '');
		$this->matauang_id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['matauang_id'] = &$this->matauang_id;

		// user_id
		$this->user_id = new DbField('t004_akun', 't004_akun', 'x_user_id', 'user_id', '`user_id`', '`user_id`', 3, 11, -1, FALSE, '`user_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`t004_akun`";
	}
	...
	{
		return ($this->SqlOrderBy != "") ? $this->SqlOrderBy : "`subgrup_id` ASC,`kode` ASC";
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "t004_akunedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "t004_akunadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("t004_akunview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("t004_akunview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "t004_akunadd.php?" . $this->getUrlParm($parm);
		else
			$url = "t004_akunadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("t004_akunedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("t004_akunadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("t004_akundelete.php", $this->getUrlParm());
	}
