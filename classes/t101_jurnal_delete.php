 ...
 * Page class
 */
class t101_jurnal_delete extends t101_jurnal
{
	...
	// Page object name
	public $PageObjName = "t101_jurnal_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t101_jurnallist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("t101_jurnallist.php"); // Return to list
			}
		}
	}
