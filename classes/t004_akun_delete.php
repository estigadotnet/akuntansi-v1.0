 ...
 * Page class
 */
class t004_akun_delete extends t004_akun
{
	...
	// Page object name
	public $PageObjName = "t004_akun_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t004_akunlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("t004_akunlist.php"); // Return to list
			}
		}
	}
