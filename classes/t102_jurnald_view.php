 ...
 * Page class
 */
class t102_jurnald_view extends t102_jurnald
{
	...
	// Page object name
	public $PageObjName = "t102_jurnald_view";
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$matchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->phrase("NoRecord")); // Set no record message
						$returnUrl = "t102_jurnaldlist.php"; // No matching record, return to list
					} else {
						$this->loadRowValues($this->Recordset); // Load row values
					}
			}
		} else {
			$returnUrl = "t102_jurnaldlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
