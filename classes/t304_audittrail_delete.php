 ...
 * Page class
 */
class t304_audittrail_delete extends t304_audittrail
{
	...
	// Page object name
	public $PageObjName = "t304_audittrail_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t304_audittraillist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("t304_audittraillist.php"); // Return to list
			}
		}
	}
