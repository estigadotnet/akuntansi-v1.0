 ...
 * Page class
 */
class t102_jurnald_grid extends t102_jurnald
{
	...
	// Page object name
	public $PageObjName = "t102_jurnald_grid";

	// Grid form hidden field names
	public $FormName = "ft102_jurnaldgrid";
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "t101_jurnal") {
			...
			if ($GLOBALS["t101_jurnal"]->EventCancelled)
