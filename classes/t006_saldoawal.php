...
/**
 * Table class for t006_saldoawal
 */
class t006_saldoawal extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 't006_saldoawal';
		$this->TableName = 't006_saldoawal';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t006_saldoawal`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new DbField('t006_saldoawal', 't006_saldoawal', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// periode_id
		$this->periode_id = new DbField('t006_saldoawal', 't006_saldoawal', 'x_periode_id', 'periode_id', '`periode_id`', '`periode_id`', 3, 11, -1, FALSE, '`periode_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->periode_id->Required = TRUE; // Required field
		...
		$this->periode_id->Lookup = new Lookup('periode_id', 't005_periode', FALSE, 'id', ["start","end","",""], [], [], [], [], [], [], '', '');
		$this->periode_id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['periode_id'] = &$this->periode_id;

		// akun_id
		$this->akun_id = new DbField('t006_saldoawal', 't006_saldoawal', 'x_akun_id', 'akun_id', '`akun_id`', '`akun_id`', 3, 11, -1, FALSE, '`akun_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// debet
		$this->debet = new DbField('t006_saldoawal', 't006_saldoawal', 'x_debet', 'debet', '`debet`', '`debet`', 4, 14, -1, FALSE, '`debet`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// kredit
		$this->kredit = new DbField('t006_saldoawal', 't006_saldoawal', 'x_kredit', 'kredit', '`kredit`', '`kredit`', 4, 14, -1, FALSE, '`kredit`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// saldo
		$this->saldo = new DbField('t006_saldoawal', 't006_saldoawal', 'x_saldo', 'saldo', '`saldo`', '`saldo`', 4, 14, -1, FALSE, '`saldo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// user_id
		$this->user_id = new DbField('t006_saldoawal', 't006_saldoawal', 'x_user_id', 'user_id', '`user_id`', '`user_id`', 3, 11, -1, FALSE, '`user_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`t006_saldoawal`";
	}
	...
	{
		return ($this->SqlOrderBy != "") ? $this->SqlOrderBy : "`akun_id` ASC";
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "t006_saldoawaledit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "t006_saldoawaladd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("t006_saldoawalview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("t006_saldoawalview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "t006_saldoawaladd.php?" . $this->getUrlParm($parm);
		else
			$url = "t006_saldoawaladd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("t006_saldoawaledit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("t006_saldoawaladd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("t006_saldoawaldelete.php", $this->getUrlParm());
	}
	...
	function Row_Rendering() {
		...
		$this->periode_id->DisplayValueSeparator = " s.d. ";
