 ...
 * Page class
 */
class t005_periode_add extends t005_periode
{
	...
	// Page object name
	public $PageObjName = "t005_periode_add";
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "t005_periodeview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->isaktif->CurrentValue = NULL;
		$this->isaktif->OldValue = $this->isaktif->CurrentValue;
	...
	protected function newRow()
	{
		...
		$row['isaktif'] = $this->isaktif->CurrentValue;
	...
	protected function addRow($rsold = NULL)
	{
		...
		if ($this->start->CurrentValue != "") { // Check field with unique index
			$filter = "(start = '" . AdjustSql($this->start->CurrentValue, $this->Dbid) . "')";
		...
		if ($this->end->CurrentValue != "") { // Check field with unique index
			$filter = "(end = '" . AdjustSql($this->end->CurrentValue, $this->Dbid) . "')";
			$rsChk = $this->loadRs($filter);
			if ($rsChk && !$rsChk->EOF) {
		...
		// start
		$this->start->setDbValueDef($rsnew, UnFormatDateTime($this->start->CurrentValue, 7), NULL, FALSE);

		// end
		$this->end->setDbValueDef($rsnew, UnFormatDateTime($this->end->CurrentValue, 7), NULL, FALSE);

		// isaktif
		$tmpBool = $this->isaktif->CurrentValue;
		if ($tmpBool != "1" && $tmpBool != "0")
			$tmpBool = !empty($tmpBool) ? "1" : "0";
		$this->isaktif->setDbValueDef($rsnew, $tmpBool, NULL, FALSE);
