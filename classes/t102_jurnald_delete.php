 ...
 * Page class
 */
class t102_jurnald_delete extends t102_jurnald
{
	...
	// Page object name
	public $PageObjName = "t102_jurnald_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t102_jurnaldlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("t102_jurnaldlist.php"); // Return to list
			}
		}
	}
