...
// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "p_akuntansi_v1_0"); // Project name
...
$CONFIG = [
	...
	"RANDOM_KEY" => '71022qy4bpDqwKo8', // Random key for encryption
	"ENCRYPTION_KEY" => '', // Encryption key for data protection
	"PROJECT_STYLESHEET_FILENAME" => "css/p_akuntansi_v1_0.css", // Project stylesheet file name
	...
	"PROJECT_ID" => "{B40DFC22-3B8C-4962-9E6E-E81BB1DAB0F7}", // Project ID (GUID)
	...
	"CONNECTION_INFO" => [
		"DB" => ["id" => "DB", "type" => "MYSQL", "qs" => "`", "qe" => "`", "host" => "localhost", "port" => 3307, "user" => "root", "pass" => "admin", "db" => "db_akuntansi_1_0"]
	],
	...
	"AUDIT_TRAIL_TABLE_NAME" => "t304_audittrail", // Audit trail table name
	"AUDIT_TRAIL_TABLE_VAR" => "t304_audittrail", // Audit trail table var
